/************************************************************************************
 Filename   : export_category_1_data.sql
...
PROMPT &V_CURR_DATE_TIME_VALUE. - Running automated DVM test cases: export_category_1_data.sql
...
--category 1 scripts:
PROMPT &V_CURR_DATE_TIME_VALUE. - Export category 1 test case data
...
spool ../verification_templates/automated/category_1_CRDMA_CDVM_issue_verification-2.csv
...
PROMPT &V_END_DATE_TIME_VALUE. - category 1 data export script has completed, the entire process took &V_ELAPSED_TIME_MIN. minutes
