...
PROMPT granting privileges to CEN_CTD schema
GRANT REFERENCES ON CCD_CRUISES TO CEN_CTD;
GRANT SELECT ON CCD_CRUISE_ALIASES_V TO CEN_CTD with grant option;

PROMPT update CCD role objects
GRANT SELECT ON CCD_CRUISES TO CCD_INTEG_ROLE;
GRANT SELECT ON CCD_CRUISE_ALIASES_V TO CCD_INTEG_ROLE;
