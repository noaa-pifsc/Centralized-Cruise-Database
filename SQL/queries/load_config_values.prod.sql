...
INSERT INTO CC_CONFIG_OPTIONS (OPTION_NAME, OPTION_VALUE, OPTION_DESC) VALUES ('DLM_SYSTEM_STATUS', 'PROD', 'Database Logging Module data system status - this configuration option determines which messages are logged in the database');
