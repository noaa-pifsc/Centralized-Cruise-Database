...
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2017 Spring MOUSS Data Set', 'This accession contains the Modular Optical Underwater Survey System (MOUSS) stereo video data from SE-17-02 (03/09/2017 - 03/22/2017) collected around the Main Hawaiian Islands (MHI) for the stock assessment of the deep-7 bottomfish species. Each video is fifteen minutes from the MOUSS touchdown on the seafloor as that is the literature based standard for deep-7 species. The products also include depth and temperature data collected using Temperature Depth Recorder (TDR) along with temporal and spatial information.', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'MOUSS Video'), '51818', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'QC'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2017 Fall MOUSS Data Set', 'This accession contains the Modular Optical Underwater Survey System (MOUSS) stereo video data from SE-17-07 (10/20/2017-11/03/2017) collected around the Main Hawaiian Islands (MHI) for the stock assessment of the deep-7 bottomfish species. Each video is fifteen minutes from the MOUSS touchdown on the seafloor as that is the literature based standard for deep-7 species. The products also include depth and temperature data collected using Temperature Depth Recorder (TDR) along with temporal and spatial information.', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'MOUSS Video'), '65049', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'IA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2015 CTD Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'CTD'), '7602', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'PA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2015 Water Samples Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Water Samples'), '25860', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'QC'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2015 Midwater Trawling Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Midwater Trawling'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'IA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2015 Active Acoustics Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Active Acoustics'), '2711', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'PA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2018 MOUSS Data Set', 'This accession contains the Modular Optical Underwater Survey System (MOUSS) stereo video data from SE-18-06 (10/17/2018 - 10/31/2018) collected around the Main Hawaiian Islands (MHI) for the stock assessment of the deep-7 bottomfish species. Each video is fifteen minutes from the MOUSS touchdown on the seafloor as that is the literature based standard for deep-7 species. The products also include depth and temperature data collected using Temperature Depth Recorder (TDR) along with temporal and spatial information.', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'MOUSS Video'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'COL'));
