...
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2016 CTD Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'CTD'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
...
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2018 CTD Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'CTD'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'PA'));
...
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2020 CTD Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'CTD'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'QC'));



--leg data sets
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-15-01'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2015 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-15-01'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2015 Water Samples Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-15-01'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2015 Midwater Trawling Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-15-01'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2015 Active Acoustics Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-17-07'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2017 Fall MOUSS Data Set'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-17-07'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2017 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-18-06'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2018 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-18-06'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2018 MOUSS Data Set'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-17-02'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2017 Spring MOUSS Data Set'));
