...
--------------------------------------------------------
--Centralized Cruise Database - version 0.12 updates:
--------------------------------------------------------
...
INSERT INTO DB_UPGRADE_LOGS (UPGRADE_APP_NAME, UPGRADE_VERSION, UPGRADE_DATE, UPGRADE_DESC) VALUES ('Centralized Cruise Database', '0.12', TO_DATE('27-APR-20', 'DD-MON-YY'), 'Updated the CCD_QC_CRUISE_V and CCD_QC_LEG_V were updated to add additional QC criteria fields');
