...
CREATE SEQUENCE CCD_DATA_SET_TYPES_SEQ INCREMENT BY 1 START WITH 1;	ALTER TABLE CCD_DATA_SET_TYPES ADD (CREATE_DATE DATE );	ALTER TABLE CCD_DATA_SET_TYPES 
ADD (CREATED_BY VARCHAR2(30) );	ALTER TABLE CCD_DATA_SET_TYPES 
ADD (LAST_MOD_DATE DATE );	ALTER TABLE CCD_DATA_SET_TYPES 
ADD (LAST_MOD_BY VARCHAR2(30) );	COMMENT ON COLUMN CCD_DATA_SET_TYPES.CREATE_DATE IS 'The date on which this record was created in the database';	COMMENT ON COLUMN CCD_DATA_SET_TYPES.CREATED_BY IS 'The Oracle username of the person creating this record in the database';	COMMENT ON COLUMN CCD_DATA_SET_TYPES.LAST_MOD_DATE IS 'The last date on which any of the data in this record was changed';	COMMENT ON COLUMN CCD_DATA_SET_TYPES.LAST_MOD_BY IS 'The Oracle username of the person making the most recent change to this record';
...
CREATE SEQUENCE CCD_DATA_SETS_SEQ INCREMENT BY 1 START WITH 1;	ALTER TABLE CCD_DATA_SETS ADD (CREATE_DATE DATE );	ALTER TABLE CCD_DATA_SETS 
ADD (CREATED_BY VARCHAR2(30) );	ALTER TABLE CCD_DATA_SETS 
ADD (LAST_MOD_DATE DATE );	ALTER TABLE CCD_DATA_SETS 
ADD (LAST_MOD_BY VARCHAR2(30) );	COMMENT ON COLUMN CCD_DATA_SETS.CREATE_DATE IS 'The date on which this record was created in the database';	COMMENT ON COLUMN CCD_DATA_SETS.CREATED_BY IS 'The Oracle username of the person creating this record in the database';	COMMENT ON COLUMN CCD_DATA_SETS.LAST_MOD_DATE IS 'The last date on which any of the data in this record was changed';	COMMENT ON COLUMN CCD_DATA_SETS.LAST_MOD_BY IS 'The Oracle username of the person making the most recent change to this record';
...
CREATE SEQUENCE CCD_REGIONS_SEQ INCREMENT BY 1 START WITH 1;	ALTER TABLE CCD_REGIONS ADD (CREATE_DATE DATE );	ALTER TABLE CCD_REGIONS 
ADD (CREATED_BY VARCHAR2(30) );	ALTER TABLE CCD_REGIONS 
ADD (LAST_MOD_DATE DATE );	ALTER TABLE CCD_REGIONS 
ADD (LAST_MOD_BY VARCHAR2(30) );	COMMENT ON COLUMN CCD_REGIONS.CREATE_DATE IS 'The date on which this record was created in the database';	COMMENT ON COLUMN CCD_REGIONS.CREATED_BY IS 'The Oracle username of the person creating this record in the database';	COMMENT ON COLUMN CCD_REGIONS.LAST_MOD_DATE IS 'The last date on which any of the data in this record was changed';	COMMENT ON COLUMN CCD_REGIONS.LAST_MOD_BY IS 'The Oracle username of the person making the most recent change to this record';
CREATE SEQUENCE ccd_leg_regions_SEQ INCREMENT BY 1 START WITH 1;	ALTER TABLE ccd_leg_regions ADD (CREATE_DATE DATE );	ALTER TABLE ccd_leg_regions 
ADD (CREATED_BY VARCHAR2(30) );	ALTER TABLE ccd_leg_regions 
ADD (LAST_MOD_DATE DATE );	ALTER TABLE ccd_leg_regions 
ADD (LAST_MOD_BY VARCHAR2(30) );	COMMENT ON COLUMN ccd_leg_regions.CREATE_DATE IS 'The date on which this record was created in the database';	COMMENT ON COLUMN ccd_leg_regions.CREATED_BY IS 'The Oracle username of the person creating this record in the database';	COMMENT ON COLUMN ccd_leg_regions.LAST_MOD_DATE IS 'The last date on which any of the data in this record was changed';	COMMENT ON COLUMN ccd_leg_regions.LAST_MOD_BY IS 'The Oracle username of the person making the most recent change to this record';
CREATE SEQUENCE ccd_cruise_legs_SEQ INCREMENT BY 1 START WITH 1;	ALTER TABLE ccd_cruise_legs ADD (CREATE_DATE DATE );	ALTER TABLE ccd_cruise_legs 
ADD (CREATED_BY VARCHAR2(30) );	ALTER TABLE ccd_cruise_legs 
ADD (LAST_MOD_DATE DATE );	ALTER TABLE ccd_cruise_legs 
ADD (LAST_MOD_BY VARCHAR2(30) );	COMMENT ON COLUMN ccd_cruise_legs.CREATE_DATE IS 'The date on which this record was created in the database';	COMMENT ON COLUMN ccd_cruise_legs.CREATED_BY IS 'The Oracle username of the person creating this record in the database';	COMMENT ON COLUMN ccd_cruise_legs.LAST_MOD_DATE IS 'The last date on which any of the data in this record was changed';	COMMENT ON COLUMN ccd_cruise_legs.LAST_MOD_BY IS 'The Oracle username of the person making the most recent change to this record';
CREATE SEQUENCE ccd_data_set_status_SEQ INCREMENT BY 1 START WITH 1;	ALTER TABLE ccd_data_set_status ADD (CREATE_DATE DATE );	ALTER TABLE ccd_data_set_status 
ADD (CREATED_BY VARCHAR2(30) );	ALTER TABLE ccd_data_set_status 
ADD (LAST_MOD_DATE DATE );	ALTER TABLE ccd_data_set_status 
ADD (LAST_MOD_BY VARCHAR2(30) );	COMMENT ON COLUMN ccd_data_set_status.CREATE_DATE IS 'The date on which this record was created in the database';	COMMENT ON COLUMN ccd_data_set_status.CREATED_BY IS 'The Oracle username of the person creating this record in the database';	COMMENT ON COLUMN ccd_data_set_status.LAST_MOD_DATE IS 'The last date on which any of the data in this record was changed';	COMMENT ON COLUMN ccd_data_set_status.LAST_MOD_BY IS 'The Oracle username of the person making the most recent change to this record';
