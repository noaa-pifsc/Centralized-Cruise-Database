...
CCD_CRUISE_AGG_V ON
DVM_PTA_RULE_SETS_RPT_V.PTA_ISS_ID = CCD_CRUISE_AGG_V.PTA_ISS_ID
order by
CCD_CRUISE_AGG_V.SCI_CENTER_DIV_NAME,
CCD_CRUISE_AGG_V.CRUISE_NAME,
CCD_CRUISE_AGG_V.CRUISE_START_DATE,
...
CCD_CRUISE_AGG_V ON
DVM_PTA_RULE_SETS_HIST_RPT_V.PTA_ISS_ID = CCD_CRUISE_AGG_V.PTA_ISS_ID
order by
CCD_CRUISE_AGG_V.SCI_CENTER_DIV_NAME,
CCD_CRUISE_AGG_V.CRUISE_NAME,
CCD_CRUISE_AGG_V.CRUISE_START_DATE,
...
ALTER PACKAGE CCD_DVM_PKG COMPILE;
	...
	IS
        ...
        select CCD_CRUISE_LEG_V.cruise_leg_id into v_cruise_leg_id
        from CCD_CRUISE_LEG_V inner join ccd_leg_aliases on ccd_leg_aliases.cruise_leg_id = CCD_CRUISE_LEG_V.cruise_leg_id
