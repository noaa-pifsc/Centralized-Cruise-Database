...
DROP CONSTRAINT CCD_DATA_SETS_U2;

CREATE UNIQUE INDEX CCD_DATA_SETS_U2 ON CCD_DATA_SETS (UPPER(DATA_SET_NAME) ASC);
...
CREATE UNIQUE INDEX CCD_SCI_CENTERS_U1 ON CCD_SCI_CENTERS (SCI_CENTER_ID, UPPER(SCI_CENTER_NAME) ASC);
...
INSERT INTO DB_UPGRADE_LOGS (UPGRADE_APP_NAME, UPGRADE_VERSION, UPGRADE_DATE, UPGRADE_DESC) VALUES ('Centralized Cruise Database', '1.0', TO_DATE('04-OCT-23', 'DD-MON-YY'), 'Upgraded from Version 0.4 (Git tag: APX_Cust_Err_Handler_db_v0.4) to	Version 1.0 (Git tag: APX_Cust_Err_Handler_db_v1.0) of the APEX custom error handler module database (Git URL: git@picgitlab.nmfs.local:centralized-data-tools/apex_tools.git in the "Error Handling" folder). Upgraded from Version 1.0 (Git tag: centralized_configuration_db_v1.0) to Version 1.1 (Git tag: centralized_configuration_db_v1.1) of the Centralized Configuration database (Git URL: git@picgitlab.nmfs.local:centralized-data-tools/centralized-configuration.git). Dropped the standalone AAM.	Adding TZ offset to cruise legs table');
