...
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('OES0908', 'Retrieved this information manually from FINSS on 1/16/20 for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = ''), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'INTERMITTENT'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = '') IS NULL THEN '' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');


--cruise legs
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('HA1007', TO_DATE('40425', 'MM/DD/YYYY'), TO_DATE('40450', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HA1007'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('OES0407', TO_DATE('38137', 'MM/DD/YYYY'), TO_DATE('38152', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'OES0407'), (select vessel_id from ccd_vessels where vessel_name = 'Oscar Elton Sette'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('OES0407 (copy)', TO_DATE('38137', 'MM/DD/YYYY'), TO_DATE('38152', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'OES0407'), (select vessel_id from ccd_vessels where vessel_name = 'Oscar Elton Sette'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('OES0410', TO_DATE('38198', 'MM/DD/YYYY'), TO_DATE('38215', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'OES0410'), (select vessel_id from ccd_vessels where vessel_name = 'Oscar Elton Sette'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('OES0908_LEGI', TO_DATE('40057', 'MM/DD/YYYY'), TO_DATE('40086', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'OES0908'), (select vessel_id from ccd_vessels where vessel_name = 'Oscar Elton Sette'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('OES0908_LEGII', TO_DATE('40092', 'MM/DD/YYYY'), TO_DATE('40116', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'OES0908'), (select vessel_id from ccd_vessels where vessel_name = 'Oscar Elton Sette'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('RL-17-05 Leg 1', TO_DATE('42964', 'MM/DD/YYYY'), TO_DATE('42983', 'MM/DD/YYYY'), 'Leg dates were retrieved via online Ship Schedule (https://sdat.noaa.gov/Account/Login?ReturnUrl=%2FHome%2FSchedule)', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'RL-17-05'), (select vessel_id from ccd_vessels where vessel_name = 'Reuben Lasker'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('RL-17-05 Leg 2', TO_DATE('42989', 'MM/DD/YYYY'), TO_DATE('43008', 'MM/DD/YYYY'), 'Leg dates were retrieved via online Ship Schedule (https://sdat.noaa.gov/Account/Login?ReturnUrl=%2FHome%2FSchedule)', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'RL-17-05'), (select vessel_id from ccd_vessels where vessel_name = 'Reuben Lasker'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('TC9909_LEGI', TO_DATE('36385', 'MM/DD/YYYY'), TO_DATE('36401', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'TC9909'), (select vessel_id from ccd_vessels where vessel_name = 'Townsend Cromwell'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID, TZ_NAME) values ('TC9909_LEGII', TO_DATE('36402', 'MM/DD/YYYY'), TO_DATE('36410', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'TC9909'), (select vessel_id from ccd_vessels where vessel_name = 'Townsend Cromwell'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'), 'US/Hawaii');
