...
BEGIN
	...
	EXCEPTION
		WHEN OTHERS THEN
			...
			execute immediate 'ALTER VIEW CCD_CRUISE_LEG_V COMPILE';
			...
			execute immediate 'ALTER VIEW CCD_CRUISE_LEG_AGG_V COMPILE';
			execute immediate 'ALTER VIEW CCD_LEG_DATA_SETS_V COMPILE';
			execute immediate 'ALTER VIEW CCD_CRUISE_LEG_DATA_SETS_MIN_V COMPILE';
			execute immediate 'ALTER VIEW CCD_CRUISE_LEG_DATA_SETS_V COMPILE';
