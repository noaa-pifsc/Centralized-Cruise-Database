...
--new test data:
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-21-01', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'INTERMITTENT'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)') IS NULL THEN 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-21-03', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Mariana Archipelago Cetacean Survey (MACS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Mariana Archipelago Cetacean Survey (MACS)') IS NULL THEN 'Mariana Archipelago Cetacean Survey (MACS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-21-04', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)') IS NULL THEN 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-21-06', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research') IS NULL THEN 'Coral Reef Ecosystem Research' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-21-07', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Mapping'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'INTERMITTENT'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Mapping') IS NULL THEN 'Coral Reef Mapping' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-21-08', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research') IS NULL THEN 'Coral Reef Ecosystem Research' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-20-04', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Hawaiian Monk Seal Population Assessment and Recovery Activities - Recovery'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'INTERMITTENT'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Hawaiian Monk Seal Population Assessment and Recovery Activities - Recovery') IS NULL THEN 'Hawaiian Monk Seal Population Assessment and Recovery Activities - Recovery' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-20-05', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Lobster Research & Bottomfishing'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Lobster Research & Bottomfishing') IS NULL THEN 'Lobster Research & Bottomfishing' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-20-08', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research') IS NULL THEN 'Coral Reef Ecosystem Research' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-20-09', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Mapping'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Mapping') IS NULL THEN 'Coral Reef Mapping' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-20-10', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research') IS NULL THEN 'Coral Reef Ecosystem Research' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-21-06', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)') IS NULL THEN 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-21-07', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Mariana Archipelago Cetacean Survey (MACS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Mariana Archipelago Cetacean Survey (MACS)') IS NULL THEN 'Mariana Archipelago Cetacean Survey (MACS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-21-08', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)') IS NULL THEN 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-21-09', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research') IS NULL THEN 'Coral Reef Ecosystem Research' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-19-01', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'INTERMITTENT'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)') IS NULL THEN 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('HI-19-02', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Mariana Archipelago Cetacean Survey (MACS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Mariana Archipelago Cetacean Survey (MACS)') IS NULL THEN 'Mariana Archipelago Cetacean Survey (MACS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-19-04', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)') IS NULL THEN 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-19-05', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research') IS NULL THEN 'Coral Reef Ecosystem Research' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-22-01', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'PSD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)') IS NULL THEN 'PIFSC - Hawaiian Islands Cetacean and Ecosystem Assessment Survey (HICEAS)' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
insert into ccd_cruises (cruise_name, cruise_notes, sci_center_div_id, std_svy_name_id, svy_freq_id, std_svy_name_oth, CRUISE_URL, CRUISE_CONT_EMAIL, svy_type_id, CRUISE_DESC, OBJ_BASED_METRICS) values ('SE-22-02', 'Fabricated for testing purposes', (select sci_center_div_id from ccd_sci_center_divs where sci_center_div_code = 'ESD'), (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research'), (select SVY_FREQ_ID from ccd_svy_freq where SVY_FREQ_name = 'ANNUAL'), (CASE WHEN (select STD_SVY_NAME_ID from ccd_std_svy_names where std_svy_name = 'Coral Reef Ecosystem Research') IS NULL THEN 'Coral Reef Ecosystem Research' ELSE NULL END), 'http://www.noaa.gov/testURL', 'test@test.com', (SELECT svy_type_id from ccd_svy_types where svy_type_name = 'NMFS Survey'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'test content');
...
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HA1007 (copy)', TO_DATE('9/4/2010', 'MM/DD/YYYY'), TO_DATE('9/29/2010', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HA1007 (copy)'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
...
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('OES0411_LEGII', TO_DATE('9/8/2005', 'MM/DD/YYYY'), TO_DATE('9/13/2005', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'OES0411'), (select vessel_id from ccd_vessels where vessel_name = 'Oscar Elton Sette'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));





insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('TC0201_LEGI', TO_DATE('1/21/2002', 'MM/DD/YYYY'), TO_DATE('2/14/2002', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'TC0201'), (select vessel_id from ccd_vessels where vessel_name = 'Townsend Cromwell'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));


insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('TC0201_LEGII', TO_DATE('5/15/2002', 'MM/DD/YYYY'), TO_DATE('7/24/2002', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'TC0201'), (select vessel_id from ccd_vessels where vessel_name = 'Townsend Cromwell'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));



insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HI1001_LEGI', TO_DATE('1/21/2010', 'MM/DD/YYYY'), TO_DATE('3/20/2010', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1001'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HI1001_LEGII', TO_DATE('3/21/2010', 'MM/DD/YYYY'), TO_DATE('6/30/2010', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1001'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HI1001_LEGIII', TO_DATE('07/05/2010', 'MM/DD/YYYY'), TO_DATE('7/21/2010', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1001'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));




insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HA1101_LEG_I', TO_DATE('11/05/2010', 'MM/DD/YYYY'), TO_DATE('4/5/2011', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1101'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HA1101_LEG_II', TO_DATE('4/7/2011', 'MM/DD/YYYY'), TO_DATE('05/03/2011', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1101'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HA1101_LEG_III', TO_DATE('5/12/2011', 'MM/DD/YYYY'), TO_DATE('7/24/2011', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1101'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
...
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('RL-17-05 Leg 6', TO_DATE('12/20/2017', 'MM/DD/YYYY'), TO_DATE('01/10/2018', 'MM/DD/YYYY'), 'Leg dates were retrieved via online Ship Schedule (https://sdat.noaa.gov/Account/Login?ReturnUrl=%2FHome%2FSchedule)', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'RL-17-05'), (select vessel_id from ccd_vessels where vessel_name = 'Reuben Lasker'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));



insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('SE-15-01 Leg 1', TO_DATE('4/3/2015', 'MM/DD/YYYY'), TO_DATE('4/14/2015', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'SE-15-01'), (select vessel_id from ccd_vessels where vessel_name = 'Oscar Elton Sette'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));


insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('SE-15-01 Leg 2', TO_DATE('4/13/2015', 'MM/DD/YYYY'), TO_DATE('5/20/2015', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'SE-15-01'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));



insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HA1102_LEG_I', TO_DATE('7/23/2011', 'MM/DD/YYYY'), TO_DATE('08/11/2011', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1102'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
insert into ccd_cruise_legs (LEG_NAME, LEG_START_DATE, LEG_END_DATE, LEG_DESC, CRUISE_ID, VESSEL_ID, PLAT_TYPE_ID) values ('HA1102_LEG_II', TO_DATE('8/15/2011', 'MM/DD/YYYY'), TO_DATE('08/30/2011', 'MM/DD/YYYY'), '', (SELECT CCD_CRUISES.CRUISE_ID FROM CCD_CRUISES where cruise_name = 'HI1102'), (select vessel_id from ccd_vessels where vessel_name = 'Hi''ialakai'), (select PLAT_TYPE_ID from CCD_PLAT_TYPES where PLAT_TYPE_NAME = 'Fishery Survey Vessel (FSV)'));
...
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'TC-03-07'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Fisheries Monitoring and Assessment'), 'Y');
...
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HA1007 (copy)'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'OES0411'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'TC0201'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
...
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-15-01'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Ecosystem Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'OES0706'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Habitat Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI0610'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
...
--test data:
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-21-01'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Habitat Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-21-03'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-21-04'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-21-06'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Ecosystem Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-21-07'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-21-08'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-20-04'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-20-05'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-20-08'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-20-09'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-20-10'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-21-06'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Ecosystem Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-21-07'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-21-08'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Ecosystem Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-21-09'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-19-01'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Ecosystem Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'HI-19-02'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Ecosystem Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-19-04'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Habitat Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-19-05'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-22-01'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Habitat Monitoring and Assessment'), 'Y');
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'SE-22-02'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Protected Species Monitoring and Assessment'), 'Y');
...
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HA1007 (copy)'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Trawl'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'OES0411_LEGI'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Snorkel/Free Dive'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'OES0411_LEGII'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'TC0201_LEGI'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Autonomous Reef Monitoring Structure (ARMS)'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'TC0201_LEGII'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI1001_LEGI'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
...
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI1001_LEGIII'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HA1101_LEG_I'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'DCIP'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HA1101_LEG_III'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'CTD'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'RL-17-05 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Seine'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'RL-17-05 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Set Net'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'RL-17-05 Leg 3'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Settlement Traps'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'RL-17-05 Leg 5'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Short bottom longline'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-15-01 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Side Scan'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-15-01 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Single Beam'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HA1102_LEG_I'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Skimmer Trawl'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HA1102_LEG_II'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'High-frequency Autonomous Acoustic Recording Package (HARP)'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'OES0706'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Hook and Line'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI0401'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Human Observation'));
...
--test data:
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-20-04 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'High-frequency Autonomous Acoustic Recording Package (HARP)'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-01 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Hook and Line'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-01 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Human Observation'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-04 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'PIT Tags'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-04 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-21-06'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Snorkel/Free Dive'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-21-07 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-21-07 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Snorkel/Free Dive'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-21-08 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Human Observation'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-20-08 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'PIT Tags'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-20-08 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-20-09 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Snorkel/Free Dive'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-20-09 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-06 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'High-frequency Autonomous Acoustic Recording Package (HARP)'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-06 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Hook and Line'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-08 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Human Observation'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-08 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'PIT Tags'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-09 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-09 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Human Observation'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-21-07'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Temperature Depth Recorders (TDRs)'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-19-01 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'PIT Tags'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-19-01 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-19-02 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Snorkel/Free Dive'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'HI-19-02 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-19-04 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Hook and Line'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-19-04 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Human Observation'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-19-05 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Hydroacoustics'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-19-05 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'IBS COD Trawl'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-22-01 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'PIT Tags'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-22-01 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'SCUBA'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-22-02 Leg 1'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Human Observation'));
INSERT INTO CCD_LEG_GEAR (CRUISE_LEG_ID, GEAR_ID) VALUES ((SELECT CRUISE_LEG_ID FROM CCD_CRUISE_LEGS WHERE LEG_NAME = 'SE-22-02 Leg 2'), (SELECT GEAR_ID FROM CCD_GEAR WHERE GEAR_NAME = 'Temperature Depth Recorders (TDRs)'));
...
--data sets
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2019 CTD Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'CTD'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2020 CTD Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'CTD'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
...
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2022 CTD Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'CTD'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'IA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2019 Water Samples Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Water Samples'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2019 Midwater Trawling Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Midwater Trawling'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2020 Water Samples Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Water Samples'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2020 Midwater Trawling Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Midwater Trawling'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2021 Water Samples Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Water Samples'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'IA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2021 Midwater Trawling Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Midwater Trawling'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'IA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2022 Water Samples Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Water Samples'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'QC'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2022 Midwater Trawling Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Midwater Trawling'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'COL'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2019 Coral Belt Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Coral Belt'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2019 Fish REA Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Fish REA'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2020 Coral Belt Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Coral Belt'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'PA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2020 Fish REA Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Fish REA'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'IA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2021 Coral Belt Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Coral Belt'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2021 Fish REA Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Fish REA'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'ARCH'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2022 Coral Belt Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Coral Belt'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'PA'));
insert into ccd_data_sets (DATA_SET_NAME, DATA_SET_DESC, DATA_SET_TYPE_ID, DATA_SET_INPORT_CAT_ID, DATA_SET_STATUS_ID) values ('2022 Fish REA Data', '', (SELECT DATA_SET_TYPE_ID FROM CCD_DATA_SET_TYPES WHERE DATA_SET_TYPE_NAME = 'Fish REA'), '', (SELECT DATA_SET_STATUS_ID FROM CCD_DATA_SET_STATUS where status_code = 'IA'));
...
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-01 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-01 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Water Samples Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-01 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-01 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Water Samples Data'));

insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-04 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-04 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-21-06'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Midwater Trawling Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-21-06'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Water Samples Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-21-06'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-21-07 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Midwater Trawling Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-21-07 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 CTD Data'));

insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-21-08 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-08 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-08 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-08 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 Fish REA Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-08 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-08 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-08 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 Water Samples Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-09 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 CTD Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-20-09 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2020 CTD Data'));

insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-06 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Fish REA Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-06 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Fish REA Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-07'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-07'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Water Samples Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-08 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-08 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-08 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Water Samples Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-09 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-21-09 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2021 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-19-04 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2019 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-19-04 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2019 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-19-05 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2019 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-19-05 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2019 Coral Belt Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-19-01 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2019 Fish REA Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-19-01 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2019 Fish REA Data'));

insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'HI-19-02 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2019 Fish REA Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-22-01 Leg 1'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2022 Midwater Trawling Data'));
insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-22-01 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2022 Midwater Trawling Data'));

insert into ccd_leg_data_sets (cruise_leg_id, DATA_SET_ID) values ((select cruise_leg_id from ccd_cruise_legs where leg_name = 'SE-22-02 Leg 2'), (SELECT DATA_SET_ID FROM CCD_DATA_SETS WHERE DATA_SET_NAME = '2022 CTD Data'));
