...
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'TC0009 (copy)'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Habitat Monitoring and Assessment'), 'Y');
...
INSERT INTO CCD_CRUISE_SVY_CATS (CRUISE_ID, SVY_CAT_ID, PRIMARY_YN) VALUES ((SELECT CRUISE_ID FROM CCD_CRUISES WHERE CRUISE_NAME = 'OES0509'), (SELECT SVY_CAT_ID FROM CCD_SVY_CATS WHERE SVY_CAT_NAME = 'Science, Services and Stewardship'), 'Y');
